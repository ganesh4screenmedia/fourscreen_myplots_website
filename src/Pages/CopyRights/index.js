...
import { connectExplanation, experinceExplanation, planExplanation, plotExplanation } from '../../Constants'
...
const CopyRight = function() {
  return <div className='main_container'>
      ...
      <div className='content_container'>
          ...
          <span className='discover_heading'>
          Discover events, parties and people
          </span>
          </div>
          <div className='plan_a_plot_container'>
          ...
          <div className='connect_container'>
              ...
              <span className='conatainer_heading' style={{color:'#FFFFFF'}}>Connect</span>
              <span className='conatainer_explanation' style={{color:'#FFFFFF'}}>{connectExplanation}</span>
          </div>
          ...
          The QR code will take you right to the app store where you can get the MyPlots app for free.
          </span>
          </div>

        ...
        <div>
          ...
          <ul>
            ...
            <li>
              ...
              this privacy notice, if we refer to:
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              <strong>To post testimonials.</strong> We post testimonials on our App that may
              ...
              delete your testimonial, please contact us at __________ and be sure to include your
            ...
            <li>
              ...
              fulfill and manage your orders, payments, returns, and exchanges made through the App.
            </li>
            <li>
              <strong>Administer prize draws and competitions.</strong> We may use your information
          ...
          <ul>
            ...
            <li>
              ...
              posting comments, contributions or other content to the App) or otherwise interact
              with public areas of the App, such personal information may be viewed by all users and
              may be publicly made available outside the App in perpetuity. Similarly, other users
          ...
          <p>
            ...
            with the App, you have the right to request removal of unwanted data that you publicly
            post on the App. To request removal of such data, please contact us using the contact
            ...
            publicly displayed on the App, but please be aware that the data may not be completely
          ...
          <table>
            ...
            <tr>
              ...
              <td>
                ...
                job title as well as work history and professional qualifications if you apply for a
                job with us
              </td>
              <td className="collectedTable">NO</td>
            </tr>
          ...
          <p>
            MyPlots has not disclosed or sold any personal information to third parties for a
            business or commercial purpose in the preceding 12 months. MyPlots will not sell
          ...
          <p>
            ...
            additional information from you for the purposes of verification. If, however, we cannot
          ...
          <p>
            If you have questions or comments about this notice, you may email us at __________ or
            by post to:
          </p>
          <p>MyPlots</p>
          <p>__________</p>
